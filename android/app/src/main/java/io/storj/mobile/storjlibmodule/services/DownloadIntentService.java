...
import io.storj.mobile.service.download.DownloadService;
...
public class DownloadIntentService extends BaseReactService {
    ...
    public final static String SERVICE_NAME = "io.storj.mobile.storjlibmodule.services.DownloadIntentService";
